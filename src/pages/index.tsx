  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application - Streamlining Your Human Resources Processes for Optimal Business Performance and Employee Satisfaction"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application - Streamlining Your Human Resources Processes for Optimal Business Performance and Employee Satisfaction`}
            </Text>
            <Box
